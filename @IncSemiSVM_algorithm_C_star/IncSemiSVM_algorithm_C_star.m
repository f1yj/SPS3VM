classdef IncSemiSVM_algorithm_C_star  
    properties
        KKT=0;
    end
    methods(Static = true)
        function obj=IncSemiSVM_algorithm_C_star(a)
            obj.KKT=a;
        end
        function [time,error, C_star_mat]=Run(val_x,val_y,original_y,extended_x,extended_y,initial_solution,extended_real_y)
            global fake_zero C_star_end C index_Q flag C_star s
            index_ox = [1:length(original_y)];
            flag=0;
            svm_struct=initial_solution;
            remove_y = svm_struct.y(1);
            g=IncSemiSVM_algorithm_C_star.GetG(svm_struct.x,svm_struct.y,svm_struct);    %get gc   
            [svm_struct,index_A,direction_A]=IncSemiSVM_algorithm_C_star.InitialA2(svm_struct,g(1),1,remove_y); 
            [Qc]=IncSemiSVM_algorithm_C_star.GetQc(svm_struct,svm_struct.x,index_A,direction_A);
            while svm_struct.alpha(1) > fake_zero || svm_struct.alpha(1) < -fake_zero
                [beta]=IncSemiSVM_algorithm_C_star.GetBeta(extended_x,extended_y,svm_struct,Qc);
                [gama] = IncSemiSVM_algorithm_C_star.GetGama(extended_x,extended_y,svm_struct,beta,direction_A,index_A);
                [max_delta,index,index_class]=IncSemiSVM_algorithm_C_star.GetMaxChange2...
                    (svm_struct,g,beta,gama,extended_y,direction_A,index_A,original_y);
                [flag,g,svm_struct,Qc,direction_A,index_A]=IncSemiSVM_algorithm_C_star.Update...
...
%                 steps=steps+1;
            ...
            d=C_star_end-C_star;
            [SPQC]=IncSemiSVM_algorithm_C_star.SPGetQc(svm_struct,d);
        while (C_star<C_star_end)
            tic;
%             if isempty(index_Q)
%                 fprintf('Q is empty\n');
%                 break;
%             end
            [beta]=IncSemiSVM_algorithm_C_star.SPGetBeta(svm_struct.x,svm_struct.y,svm_struct,SPQC);
            [gama]=IncSemiSVM_algorithm_C_star.SPGetGama(svm_struct.x,svm_struct.y,svm_struct,beta,d);
            [max_delta,index,index_class]=IncSemiSVM_algorithm_C_star.SPGetMaxChange...
                (svm_struct,g,beta,gama,svm_struct.y,d,svm_struct.y);
            [g,svm_struct,SPQC,d]=IncSemiSVM_algorithm_C_star.SPUpdate...
...
%                 prePms0(2) = upp_tmp;
                ...
                g1=IncSemiSVM_algorithm_C_star.GetG(test_svm.x,test_svm.y,test_svm);    %get gc
               
                
                [test_svm,index_A,direction_A]=IncSemiSVM_algorithm_C_star.InitialA3(test_svm,g(end),length(g),y_0);
               
                
                [Qc]=IncSemiSVM_algorithm_C_star.GetQc(test_svm,test_svm.x,index_A,direction_A);
%                 if index_A>1
%                     fprintf('add x0 y0 error\n');
%                 end
                tic;
                while length(index_A)>0
                    [beta_new]=IncSemiSVM_algorithm_C_star.GetBeta(extended_x,extended_y,test_svm,Qc);
                    [gama_new] = IncSemiSVM_algorithm_C_star.GetGama(extended_x,extended_y,test_svm,beta_new,direction_A,index_A);
                    [max_delta,index,index_class]=IncSemiSVM_algorithm_C_star.GetMaxChange...
                        (test_svm,g1,beta_new,gama_new,test_svm.y,direction_A,index_A,original_y);
                    [flag,g1,test_svm,Qc,direction_A,index_A]=IncSemiSVM_algorithm_C_star.Update...
...
%             per1 = getAcc(y1,y2);
            Q_LnonZero = SemiSVM.Kernel(test_svm.x, val_x);
            pred = sign((Q_LnonZero' * test_svm.alpha) .* val_y + test_svm.b);
            per1 = getAcc(val_y,pred);

            error=[error;per1];
            time=[time;t1];
            C_star_mat = [C_star_mat; C_star];
        end
    end

            %using IL-S3VM again end -------------increment alpha0
%             [svm_struct,label_size]=IncSemiSVM_algorithm_C_star.ModifyDataAfterInc(original_y,added_y,svm_struct);
...
%             out=svm_struct;
        ...
        function   [flag,out_g,out_svm_struct,out_Qc,direction_A,index_A]=Update...
            ...
            [flag,out_svm_struct,direction_A,index_A]=IncSemiSVM_algorithm_C_star.UpdataSvmstruct(svm_struct,beta,max_delta,index,y,direction_A,index_A,index_class);
            [out_g]=IncSemiSVM_algorithm_C_star.UpdataG(g,svm_struct,gama,max_delta);
            [out_Qc]=IncSemiSVM_algorithm_C_star.GetQc(out_svm_struct,x,index_A,direction_A);
        end
        ...
        function  [max_delta_zeta,index,index_class]=GetMaxChange...
            ...
            [max_change_alpha,index_max_change_alpha,class_alpha]=IncSemiSVM_algorithm_C_star.FindChangeAlpha(svm_struct,beta);
            [max_change_g,index_max_change_g,class_g]=IncSemiSVM_algorithm_C_star.FindMaxChangeG(svm_struct,g,gama);
            [max_change_A,index_max_change_A,class_A]=IncSemiSVM_algorithm_C_star.FindChangeA...
                (svm_struct,y,beta, direction_A,index_A,g,gama);
            [max_change_toA,index_max_change_toA,class_toA]=IncSemiSVM_algorithm_C_star.FindChangeToA...
                (svm_struct,y, index_A,g,gama,original_y);
            [max_delta_zeta,index,index_class]=IncSemiSVM_algorithm_C_star.FindMaxChange...
        ...
        function  [max_delta_zeta,index,index_class]=GetMaxChange2...
            ...
            [max_change_alpha,index_max_change_alpha,class_alpha]=IncSemiSVM_algorithm_C_star.FindChangeAlpha(svm_struct,beta);
            [max_change_g,index_max_change_g,class_g]=IncSemiSVM_algorithm_C_star.FindMaxChangeG(svm_struct,g,gama);
            [max_change_A,index_max_change_A,class_A]=IncSemiSVM_algorithm_C_star.FindChangeA2...
                (svm_struct,y,beta, direction_A,index_A,g,gama);
            [max_change_toA,index_max_change_toA,class_toA]=IncSemiSVM_algorithm_C_star.FindChangeToA...
                (svm_struct,y, index_A,g,gama,original_y);
            [max_delta_zeta,index,index_class]=IncSemiSVM_algorithm_C_star.FindMaxChange...
...
%             length_other_set=length(other_set);
        ...
        function    beta=GetBeta(x,y,svm_struct,Qc)
            Q=IncSemiSVM_algorithm_C_star.FindQR(x,y,svm_struct);
            if det(Q)<1e-42
                m=length(Q);
                n=eye(m);
                Q=Q+1e-7*n;
...
%             end
        ...
        function    beta=SPGetBeta(x,y,svm_struct,Qc)
            Q=IncSemiSVM_algorithm_C_star.SPFindQR(x,svm_struct);
        ...
        function   [out_g,out_svm_struct,out_Qc,direction]=SPUpdate...
            ...
            [out_svm_struct,direction,index_A]=IncSemiSVM_algorithm_C_star.SPUpdataSvmstruct(svm_struct,beta,max_delta,index,y,direction,index_class);
            [out_g,pms]=IncSemiSVM_algorithm_C_star.SPUpdataG(g,gama,max_delta,svm_struct);
            % other case
            if ~isempty(index_A)
                fprintf('A ~isempty \n');
            ...
            [out_Qc]=IncSemiSVM_algorithm_C_star.SPGetQc(out_svm_struct,direction);
        end
        ...
        function  [out_svm_struct,direction_A,index_A] = SPUpdataSvmstruct...
            ...
            global  fake_zero C C_star_end C_star flag
            index_A=[];
            local_beta=beta;
            local_beta_length=length(local_beta);
            beta_b=beta(1);
...
%             svm_struct.alpha=alpha;
        ...
        function  [max_delta_zeta,index,index_class]=SPGetMaxChange...
            ...
            [max_change_alpha,index_max_change_alpha,class_alpha]=IncSemiSVM_algorithm_C_star.SPFindChangeAlpha(svm_struct,beta,direction);
            [max_change_g,index_max_change_g,class_g]=IncSemiSVM_algorithm_C_star.SPFindMaxChangeG(svm_struct,g,gama);
            [max_change_toA,index_max_change_toA,class_toA]=IncSemiSVM_algorithm_C_star.SPFindChangeToA...
                (svm_struct,y,g,gama,original_y);
            [max_delta_zeta,index,index_class]=IncSemiSVM_algorithm_C_star.SPFindMaxChange...
                (max_change_alpha, index_max_change_alpha,max_change_g,...
