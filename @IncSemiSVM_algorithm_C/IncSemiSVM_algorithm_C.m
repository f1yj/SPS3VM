classdef IncSemiSVM_algorithm_C
    properties
        KKT=0;
    end
    methods(Static = true)
        function obj=IncSemiSVM_algorithm_C(a)
            obj.KKT=a;
        end
        function [time,error,C_mat]=Run(val_x,val_y,original_y,extended_x,extended_y,initial_solution,~)
            global fake_zero C_end C index_Q flag
            flag=0;
            svm_struct=initial_solution;
            remove_y = svm_struct.y(1);
            g=IncSemiSVM_algorithm_C.GetG(svm_struct.x,svm_struct.y,svm_struct);    %get gc   
            [svm_struct,index_A,direction_A]=IncSemiSVM_algorithm_C.InitialA2(svm_struct,g(1),1,remove_y); 
            [Qc]=IncSemiSVM_algorithm_C.GetQc(svm_struct,svm_struct.x,index_A,direction_A);
            while svm_struct.alpha(1) > fake_zero || svm_struct.alpha(1) < -fake_zero
                [beta]=IncSemiSVM_algorithm_C.GetBeta(extended_x,extended_y,svm_struct,Qc);
                [gama] = IncSemiSVM_algorithm_C.GetGama(extended_x,extended_y,svm_struct,beta,direction_A,index_A);
                [flag_MAX_CHANGE,max_delta,index,index_class]=IncSemiSVM_algorithm_C.GetMaxChange2...
                    (svm_struct,g,beta,gama,extended_y,direction_A,index_A,original_y);
                if flag_MAX_CHANGE == 0
                    break;
                end
                [flag,g,svm_struct,Qc,direction_A,index_A]=IncSemiSVM_algorithm_C.Update...
            ...
            time = [];
            C_mat = [];
            index_Q=[svm_struct.index_E(svm_struct.alpha(svm_struct.index_E)~=0);svm_struct.index_O(svm_struct.alpha(svm_struct.index_O)~=0)];
            d=C_end-C;
            [SPQC]=IncSemiSVM_algorithm_C.SPGetQc(svm_struct,d);
            while (C<C_end)
                tic;
                if isempty(index_Q)
                    break;
                end
                [beta]=IncSemiSVM_algorithm_C.SPGetBeta(svm_struct.x,svm_struct.y,svm_struct,SPQC);
                [gama]=IncSemiSVM_algorithm_C.SPGetGama(svm_struct.x,svm_struct.y,svm_struct,beta,d);
                [max_delta,index,index_class]=IncSemiSVM_algorithm_C.SPGetMaxChange...
                    (svm_struct,g,beta,gama,svm_struct.y,d,svm_struct.y);
                [g,svm_struct,SPQC,d]=IncSemiSVM_algorithm_C.SPUpdate...
        ...
        function   [flag,out_g,out_svm_struct,out_Qc,direction_A,index_A]=Update...
            ...
            [flag,out_svm_struct,direction_A,index_A]=IncSemiSVM_algorithm_C.UpdataSvmstruct(svm_struct,beta,max_delta,index,y,direction_A,index_A,index_class);
            [out_g]=IncSemiSVM_algorithm_C.UpdataG(g,svm_struct,gama,max_delta);
            [out_Qc]=IncSemiSVM_algorithm_C.GetQc(out_svm_struct,x,index_A,direction_A);
        end
        ...
        function  [max_delta_zeta,index,index_class]=GetMaxChange...
            ...
            [max_change_alpha,index_max_change_alpha,class_alpha]=IncSemiSVM_algorithm_C.FindChangeAlpha(svm_struct,beta);
            [max_change_g,index_max_change_g,class_g]=IncSemiSVM_algorithm_C.FindMaxChangeG(svm_struct,g,gama);
            [max_change_A,index_max_change_A,class_A]=IncSemiSVM_algorithm_C.FindChangeA...
                (svm_struct,y,beta, direction_A,index_A,g,gama);
            [max_change_toA,index_max_change_toA,class_toA]=IncSemiSVM_algorithm_C.FindChangeToA...
                (svm_struct,y, index_A,g,gama,original_y);
            [max_delta_zeta,index,index_class]=IncSemiSVM_algorithm_C.FindMaxChange...
        ...
        function  [flag_MAX_CHANGE,max_delta_zeta,index,index_class]=GetMaxChange2...
                (svm_struct,g,beta,gama,y,direction_A,index_A,original_y)
            [max_change_alpha,index_max_change_alpha,class_alpha]=IncSemiSVM_algorithm_C.FindChangeAlpha(svm_struct,beta);
            [max_change_g,index_max_change_g,class_g]=IncSemiSVM_algorithm_C.FindMaxChangeG(svm_struct,g,gama);
            [flag_MAX_CHANGE,max_change_A,index_max_change_A,class_A]=IncSemiSVM_algorithm_C.FindChangeA2...
                (svm_struct,y,beta, direction_A,index_A,g,gama);
            [max_change_toA,index_max_change_toA,class_toA]=IncSemiSVM_algorithm_C.FindChangeToA...
                (svm_struct,y, index_A,g,gama,original_y);
            [max_delta_zeta,index,index_class]=IncSemiSVM_algorithm_C.FindMaxChange...
        ...
        function [flag_MAX_CHANGE,max_change_A, index_max_change_A, class_A] = FindChangeA2...
                (svm_struct,y,beta,direction_A,index_A,g,gama)
            % condition 4 in the paper
            global fake_zero
            flag_MAX_CHANGE = 1;
...
%             length_other_set=length(other_set);
        ...
        function    beta=GetBeta(x,y,svm_struct,Qc)
            Q=IncSemiSVM_algorithm_C.FindQR(x,y,svm_struct);
            if det(Q)<1e-42
                m=length(Q);
                n=eye(m);
                Q=Q+1e-7*n;
...
%             end
        ...
        function    beta=SPGetBeta(x,y,svm_struct,Qc)
            Q=IncSemiSVM_algorithm_C.SPFindQR(x,svm_struct);
        ...
        function   [out_g,out_svm_struct,out_Qc,direction]=SPUpdate...
            ...
            global index_Q flag
            [out_svm_struct,direction,index_A]=IncSemiSVM_algorithm_C.SPUpdataSvmstruct(svm_struct,beta,max_delta,index,y,direction,index_class);
            [out_g,pms]=IncSemiSVM_algorithm_C.SPUpdataG(g,gama,max_delta,svm_struct);
            % other case
            if ~isempty(index_A)
                flag=1;
            end
            out_svm_struct.pms=pms;
            index_Q=[out_svm_struct.index_E(out_svm_struct.alpha(out_svm_struct.index_E)~=0);out_svm_struct.index_O(out_svm_struct.alpha(out_svm_struct.index_O)~=0)];
            [out_Qc]=IncSemiSVM_algorithm_C.SPGetQc(out_svm_struct,direction);
        end
...
%             svm_struct.alpha=alpha;
        ...
        function  [max_delta_zeta,index,index_class]=SPGetMaxChange...
            ...
            [max_change_alpha,index_max_change_alpha,class_alpha]=IncSemiSVM_algorithm_C.SPFindChangeAlpha(svm_struct,beta,direction);
            [max_change_g,index_max_change_g,class_g]=IncSemiSVM_algorithm_C.SPFindMaxChangeG(svm_struct,g,gama);
            [max_change_toA,index_max_change_toA,class_toA]=IncSemiSVM_algorithm_C.SPFindChangeToA...
                (svm_struct,y,g,gama,original_y);
            [max_delta_zeta,index,index_class]=IncSemiSVM_algorithm_C.SPFindMaxChange...
                (max_change_alpha, index_max_change_alpha,max_change_g,...
