classdef IncSemiSVM_algorithm_s  
    properties
        KKT=0;
    end
    methods(Static = true)
        function obj=IncSemiSVM_algorithm_s(a)
            obj.KKT=a;
        end
        function [time,error, s_mat]=Run(val_x,val_y,original_y,extended_x,extended_y,initial_solution,~)
            global fake_zero C_star_end C index_Q flag C_star s s_end
            flag=0;
            svm_struct=initial_solution;
            remove_y = svm_struct.y(1);
            g=IncSemiSVM_algorithm_s.GetG(svm_struct.x,svm_struct.y,svm_struct);    %get gc   
            [svm_struct,index_A,direction_A]=IncSemiSVM_algorithm_s.InitialA2(svm_struct,g(1),1,remove_y); 
            [Qc]=IncSemiSVM_algorithm_s.GetQc(svm_struct,svm_struct.x,index_A,direction_A);
            while svm_struct.alpha(1) > fake_zero || svm_struct.alpha(1) < -fake_zero
                [beta]=IncSemiSVM_algorithm_s.GetBeta(extended_x,extended_y,svm_struct,Qc);
                [gama] = IncSemiSVM_algorithm_s.GetGama(extended_x,extended_y,svm_struct,beta,direction_A,index_A);
                [max_delta,index,index_class]=IncSemiSVM_algorithm_s.GetMaxChange2...
                    (svm_struct,g,beta,gama,extended_y,direction_A,index_A,original_y);
                [flag,g,svm_struct,Qc,direction_A,index_A]=IncSemiSVM_algorithm_s.Update...
            ...
            d=C_star_end-C_star;
            [SPQC]=IncSemiSVM_algorithm_s.SPGetQc(svm_struct,d);
            while (s < s_end)
                tic;
                [beta]=IncSemiSVM_algorithm_s.SPGetBeta(svm_struct.x,svm_struct.y,svm_struct,SPQC);
                [gama]=IncSemiSVM_algorithm_s.SPGetGama(svm_struct.x,svm_struct.y,svm_struct,beta,d);
                [max_delta,index,index_class]=IncSemiSVM_algorithm_s.SPGetMaxChange...
                    (svm_struct,g,beta,gama,svm_struct.y,d,svm_struct.y);
                [g,svm_struct,SPQC,d]=IncSemiSVM_algorithm_s.SPUpdate...
                ...
                while ~isempty(index_Q)
                    ...
                    g1=IncSemiSVM_algorithm_s.GetG(test_svm.x,test_svm.y,test_svm);    %get gc
                    [test_svm,index_A,direction_A]=IncSemiSVM_algorithm_s.InitialA3(test_svm,g(end),length(g),y_0);
                    [Qc]=IncSemiSVM_algorithm_s.GetQc(test_svm,test_svm.x,index_A,direction_A);
                    tic;
                    while ~isempty(index_A)
                        [beta_new]=IncSemiSVM_algorithm_s.GetBeta(extended_x,extended_y,test_svm,Qc);
                        [gama_new] = IncSemiSVM_algorithm_s.GetGama(extended_x,extended_y,test_svm,beta_new,direction_A,index_A);
                        [max_delta,index,index_class]=IncSemiSVM_algorithm_s.GetMaxChange...
                            (test_svm,g1,beta_new,gama_new,test_svm.y,direction_A,index_A,original_y);
                        [flag,g1,test_svm,Qc,direction_A,index_A]=IncSemiSVM_algorithm_s.Update...
        ...
        function   [flag,out_g,out_svm_struct,out_Qc,direction_A,index_A]=Update...
            ...
            [flag,out_svm_struct,direction_A,index_A]=IncSemiSVM_algorithm_s.UpdataSvmstruct(svm_struct,beta,max_delta,index,y,direction_A,index_A,index_class);
            [out_g]=IncSemiSVM_algorithm_s.UpdataG(g,svm_struct,gama,max_delta);
            [out_Qc]=IncSemiSVM_algorithm_s.GetQc(out_svm_struct,x,index_A,direction_A);
        end
        ...
        function  [flag,out_svm_struct,direction_A,index_A] = UpdataSvmstruct...
                (svm_struct,beta,max_delta,index,~,direction_A,index_A,index_class)
            flag=0;
            local_beta=beta;
        ...
        function  [max_delta_zeta,index,index_class]=GetMaxChange...
            ...
            [max_change_alpha,index_max_change_alpha,class_alpha]=IncSemiSVM_algorithm_s.FindChangeAlpha(svm_struct,beta);
            [max_change_g,index_max_change_g,class_g]=IncSemiSVM_algorithm_s.FindMaxChangeG(svm_struct,g,gama);
            [max_change_A,index_max_change_A,class_A]=IncSemiSVM_algorithm_s.FindChangeA...
                (svm_struct,y,beta, direction_A,index_A,g,gama);
            [max_change_toA,index_max_change_toA,class_toA]=IncSemiSVM_algorithm_s.FindChangeToA...
                (svm_struct,y, index_A,g,gama,original_y);
            [max_delta_zeta,index,index_class]=IncSemiSVM_algorithm_s.FindMaxChange...
        ...
        function  [max_delta_zeta,index,index_class]=GetMaxChange2...
            ...
            [max_change_alpha,index_max_change_alpha,class_alpha]=IncSemiSVM_algorithm_s.FindChangeAlpha(svm_struct,beta);
            [max_change_g,index_max_change_g,class_g]=IncSemiSVM_algorithm_s.FindMaxChangeG(svm_struct,g,gama);
            [max_change_A,index_max_change_A,class_A]=IncSemiSVM_algorithm_s.FindChangeA2...
                (svm_struct,y,beta, direction_A,index_A,g,gama);
            [max_change_toA,index_max_change_toA,class_toA]=IncSemiSVM_algorithm_s.FindChangeToA...
                (svm_struct,y, index_A,g,gama,original_y);
            [max_delta_zeta,index,index_class]=IncSemiSVM_algorithm_s.FindMaxChange...
        ...
        function [max_change_A, index_max_change_A, class_A] = FindChangeA2...
                (svm_struct,~,~,direction_A,index_A,g,gama)
            global fake_zero
            class_A=inf;
            local_g=g(index_A);
            local_gama=gama(index_A);
        ...
        function [max_change_toA,index_max_change_toA, class_toA]=FindChangeToA...
            ...
            if isempty(local_change_g)
                ...
                if ~isempty(find(index_A==index_max_change_toA, 1))
...
%             length_other_set=length(other_set);
        ...
        function    beta=GetBeta(x,y,svm_struct,Qc)
            Q=IncSemiSVM_algorithm_s.FindQR(x,y,svm_struct);
            if det(Q)<1e-42
                m=length(Q);
                n=eye(m);
                Q=Q+1e-7*n;
...
%             end
        ...
        function    beta=SPGetBeta(x,~,svm_struct,Qc)
            Q=IncSemiSVM_algorithm_s.SPFindQR(x,svm_struct);
        ...
        function   [out_g,out_svm_struct,out_Qc,direction]=SPUpdate...
                (svm_struct,g,beta,gama,max_delta,index,~,y,direction,index_class)
            global index_Q flag C
            [out_svm_struct,direction,index_A]=IncSemiSVM_algorithm_s.SPUpdataSvmstruct(svm_struct,beta,max_delta,index,y,direction,index_class);
            [out_g,pms]=IncSemiSVM_algorithm_s.SPUpdataG(g,gama,max_delta,svm_struct);
            % other case
            if ~isempty(index_A)
                flag=1;
            end
            ...
            [out_Qc]=IncSemiSVM_algorithm_s.SPGetQc(out_svm_struct,direction);
        end
        ...
        function  [out_svm_struct,direction_A,index_A] = SPUpdataSvmstruct...
                (svm_struct,beta,max_delta,index,~,d,index_class)
            global  fake_zero C C_star flag s s_end
            index_A=[];
            local_beta=beta;
            local_beta_length=length(local_beta);
            beta_b=beta(1);
        ...
        function  [max_delta_zeta,index,index_class]=SPGetMaxChange...
            ...
            [max_change_alpha,index_max_change_alpha,class_alpha]=IncSemiSVM_algorithm_s.SPFindChangeAlpha(svm_struct,beta,direction);
            [max_change_g,index_max_change_g,class_g]=IncSemiSVM_algorithm_s.SPFindMaxChangeG(svm_struct,g,gama);
            [max_change_toA,index_max_change_toA,class_toA]=IncSemiSVM_algorithm_s.SPFindChangeToA...
                (svm_struct,y,g,gama,original_y);
            [max_delta_zeta,index,index_class]=IncSemiSVM_algorithm_s.SPFindMaxChange...
                (max_change_alpha, index_max_change_alpha,max_change_g,...
